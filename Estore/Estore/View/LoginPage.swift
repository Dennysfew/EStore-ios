...
struct LoginPage: View {
        ...
        VStack{
            ...
            ScrollView(.vertical, showsIndicators: false) {
                ...
                VStack(spacing: 15) {
                    ...
                    CustomTextField(icon: "envelope", title: "Email", hint: "email@gmail.com", value: $loginData.email, showPassword:.constant(false) )
                        .padding(.top, 25)
    ...
    func CustomTextField(icon: String, title: String, hint: String, value: Binding<String>, showPassword: Binding<Bool>)->some View {
        ...
        // Showing Show Buttom for password Field...
